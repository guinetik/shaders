const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ShaderDetailView-BOrsCD87.js","assets/ShaderDetailView-7pD7n_xN.css"])))=>i.map(i=>d[i]);
...
`}]},{slug:"exoplanets",title:"Exoplanets Study",description:"A procedural solar system with a star and three different planet types",date:"2025-11-26",tags:["exoplanets","raymarching","3d","space","interactive"],links:{},screenshotUrl:mf,passes:{image:`/**\r
 * Exoplanets Study\r
 * @author guinetik\r
 * @date 2025-11-26\r
 *\r
...
`}]},{slug:"nebulae",title:"Nebulae Generator",description:"Procedural nebulae with heterogeneous density, dust lanes, emission knots, dark nebulae, galaxies, storms with lightning, and stars. Cinematic camera cuts with auto-pan or mouse drag override.",date:"2025-11-25",tags:["procedural","space","interactive"],links:{},screenshotUrl:Sf,passes:{image:`/**\r
...
`}]},{slug:"planet-gas-giant",title:"Gas Giant",description:"Jupiter-like gas giant with alternating tan zones and brown belts, turbulent eddies at band boundaries, and the Great Red Spot. Fully procedural with no texture dependencies.",date:"2025-11-27",tags:["exoplanets","space","3d"],links:{},screenshotUrl:wf,passes:{image:`/**
 * Gas Giant (Jupiter)
 * @author guinetik
 * @date 2025-11-27
 *
...
`}]},{slug:"planet-lava",title:"Lava World",description:"A molten lava planet with boiling surface, glowing cracks, atmospheric haze, and volumetric corona rays. Fully procedural using simplex noise.",date:"2025-11-27",tags:["exoplanets","space","3d"],links:{},screenshotUrl:Tf,passes:{image:`/**
 * Lava World
 * @author guinetik
 * @date 2025-11-27
 *
...
`}]},{slug:"planet-neptune-like",title:"Neptune-like",description:"A Neptune-like ice giant with colorful banded atmosphere, turbulent storms, and dramatic lighting. Fully procedural with no texture dependencies.",date:"2025-11-27",tags:["exoplanets","space","3d"],links:{},screenshotUrl:Cf,passes:{image:`/**
...
`}]},{slug:"star-blue-giant",title:"Blue Giant",description:"A massive blue giant star with a smooth, intense surface and powerful corona glow. Temperature at ~20000K with low but steady stellar activity.",date:"2025-11-29",tags:["exoplanets","space","3d","raymarching"],links:{},screenshotUrl:Df,passes:{image:`/**
 * Blue Giant Star
 * @author guinetik
 * @date 2025-11-29
 *
...
`}]},{slug:"star-red-dwarf",title:"Red Dwarf",description:"A small, turbulent red dwarf star with orange-red boiling plasma, active flares, and prominent corona. Temperature locked at ~3000K with high stellar activity.",date:"2025-11-29",tags:["exoplanets","space","3d","raymarching"],links:{},screenshotUrl:Pf,passes:{image:`/**
 * Red Dwarf Star
 * @author guinetik
 * @date 2025-11-29
 *
...
`}]},{slug:"star-study",title:"Star Study",description:"A procedural star with boiling plasma surface and an orbiting planet",date:"2025-11-30",tags:["exoplanets","space","3d","raymarching"],links:{},screenshotUrl:Lf,passes:{image:`/**\r
...
`}]},{slug:"star-sun",title:"Solar",description:"Our Sun rendered as a yellow-white star with balanced convection cells, moderate flare activity, and a warm corona glow. Temperature set to 5778K.",date:"2025-11-29",tags:["exoplanets","space","3d","raymarching"],links:{},screenshotUrl:Of,passes:{image:`/**
 * Solar Star
 * @author guinetik
 * @date 2025-11-29
 *
...
`}]},{slug:"thomas",title:"Attractor Study #04: Thomas",description:"Thomas' cyclically symmetric attractor (1999) with 16 particles traced through 3D phase space. Drag to rotate.",date:"2026-02-13",tags:["attractors","simulation","3d"],links:{},screenshotUrl:Hf,passes:{image:`/**
...
`}]},{slug:"waves",title:"Smooth Waves",description:"Dali-inspired liquid with layered sine waves, center ripple source, corner-based interference patterns, and heat shimmer. Smooth flowing animation with displacement edge highlighting.",date:"2026-01-29",tags:["10-days","procedural"],links:{},screenshotUrl:kf,passes:{image:`/**\r
...
`},channels:{image:{iChannel0:"textures/sea.jpg"}},commonsSources:[]}],Mr=[...ji].sort((e,n)=>new Date(n.date).getTime()-new Date(e.date).getTime()),Bf=[...new Set(ji.flatMap(e=>e.tags))].sort();function yd(e){return Mr.find(n=>n.slug===e)}function Ff(){const e=Ce(null),n=ke(()=>e.value===null?Mr:Mr.filter(r=>r.tags.includes(e.value)));function t(r){e.value=e.value===r?null:r}return{activeTag:e,allTags:Bf,filteredShaders:n,setTag:t}}const Uf=Math.PI*.5,va=150;function Hr(e,n,t,r=0){let o=null,a=null,i=0,s=null,l=0,f="none",c=0;function d(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function m(){return window.matchMedia("(hover: hover)").matches}function v(){o=document.createElement("canvas"),o.style.cssText="position:fixed;pointer-events:none;z-index:50;opacity:0;transition:none;",o.setAttribute("aria-hidden","true"),document.body.appendChild(o),a=o.getContext("2d")}function T(S){if(!o)return;const A=S.getBoundingClientRect(),L=getComputedStyle(S).borderRadius||"0";o.style.top=`${A.top+r}px`,o.style.left=`${A.left}px`,o.style.width=`${A.width}px`,o.style.height=`${A.height}px`,o.style.borderRadius=L,o.style.overflow="hidden";const G=window.devicePixelRatio||1,V=Math.round(A.width*G),oe=Math.round(A.height*G);(o.width!==V||o.height!==oe)&&(o.width=V,o.height=oe)}function w(S){if((!o||!a||!s)&&f==="none"&&l<=0)return;const A=c?S-c:16;if(c=S,f==="in")l=Math.min(1,l+A/va),l>=1&&(f="none");else if(f==="out"&&(l=Math.max(0,l-A/va),l<=0)){f="none",o&&(o.style.opacity="0");return}if(o&&(o.style.opacity=String(l)),!o||!a)return;s&&T(s);const _=window.devicePixelRatio||1,L=o.width/_,G=o.height/_;a.setTransform(_,0,0,_,0,0),a.clearRect(0,0,L,G);const V=S*.001*zc,oe=G*.5;for(let H=0;H<2;H++){const Y=H===0?0:Uf,$=H===0?.5:.25;a.beginPath(),a.strokeStyle=`rgba(17, 220, 255, ${$})`,a.lineWidth=Gc,a.shadowColor=`rgba(17, 220, 255, ${$*.5})`,a.shadowBlur=Vc;for(let I=0;I<=L;I+=2){const X=oe+Math.sin(I/L*Math.PI*2*Uc+V+Y)*Fc;I===0?a.moveTo(I,X):a.lineTo(I,X)}a.stroke(),a.shadowBlur=0}i=requestAnimationFrame(w)}function k(S){if(d()||!m())return;const A=S.target.closest(n);if(!A)return;o||v();const _=t?A.querySelector(t)??A:A;s=_,T(_),f="in",cancelAnimationFrame(i),c=0,i=requestAnimationFrame(w)}function M(S){if(!S.target.closest(n))return;const _=S.relatedTarget;_&&_.closest(n)||(s=null,f="out",cancelAnimationFrame(i),c=0,i=requestAnimationFrame(w))}Qn(()=>{const S=e.value;S&&(S.addEventListener("mouseenter",k,!0),S.addEventListener("mouseleave",M,!0))}),St(()=>{cancelAnimationFrame(i);const S=e.value;S&&(S.removeEventListener("mouseenter",k,!0),S.removeEventListener("mouseleave",M,!0)),o&&o.parentNode&&o.parentNode.removeChild(o),o=null,a=null,s=null})}const zf=["onClick"],Gf=An({__name:"TagFilter",props:{tags:{},activeTag:{}},emits:["select"],setup(e,{emit:n}){const t=n,r=Ce(null);return Hr(r,".tag-btn"),(o,a)=>(Ae(),Fe("div",{ref_key:"filterRef",ref:r,class:"tag-filter"},[Pe("button",{class:Wn(["tag-btn",{active:e.activeTag===null}]),onClick:a[0]||(a[0]=i=>t("select",null))}," All ",2),(Ae(!0),Fe(Te,null,$r(e.tags,i=>(Ae(),Fe("button",{key:i,class:Wn(["tag-btn",{active:e.activeTag===i}]),onClick:s=>t("select",i)},ot(i),11,zf))),128))],512))}}),Vf=wt(Gf,[["__scopeId","data-v-f002c231"]]),qf={class:"card-trace-svg","aria-hidden":"true"},Wf=["stroke-dasharray","stroke-dashoffset"],Kf={class:"card-content"},Yf=["src","alt"],Xf={class:"card-overlay"},jf={class:"card-kicker"},Qf={class:"card-title"},Zf={class:"card-tags"},$f=An({__name:"ShaderCard",props:{shader:{},index:{},total:{}},setup(e,{expose:n}){const t=e,r=af(),{prefersReducedMotion:o,getStaggerDelay:a,setTransitionSnapshot:i}=oo(),s=Ce(null),l=Ce(null),f=Ce("hidden"),c=Ce(0);let d=null,m=0,v=!1,T=0;function w(){const _=s.value;if(!_)return null;const L=_.$el;return L instanceof HTMLElement?L:null}function k(_){const L=l.value;if(!L||!c.value){f.value="visible";return}T=window.setTimeout(()=>{f.value="tracing",L.animate([{strokeDashoffset:c.value},{strokeDashoffset:0}],{duration:Yo,easing:"cubic-bezier(0.25, 0.1, 0.25, 1)",fill:"forwards"}).finished.then(()=>{f.value="filling",setTimeout(()=>{f.value="visible"},Xo)})},_)}function M(){clearTimeout(T),f.value="hidden";const _=l.value;_&&_.getAnimations().forEach(L=>L.cancel())}Qn(()=>{if(o.value==="reduced"){f.value="visible";return}const _=w(),L=l.value;if(!_||!L){f.value="visible";return}const G=_.getBoundingClientRect();c.value=(G.width+G.height)*2,m=performance.now(),d=new IntersectionObserver(V=>{const oe=V[0];if(oe)if(oe.isIntersecting){const H=!v&&performance.now()-m<100;H&&(v=!0);const Y=H?a(t.index,t.total):0;k(Y)}else(v||performance.now()-m>100)&&M()},{rootMargin:"0px 0px 75px 0px"}),d.observe(_)}),St(()=>{d==null||d.disconnect(),d=null,clearTimeout(T)});function S(){if(o.value==="reduced"){f.value="visible";return}const _=l.value;if(!_||!c.value){f.value="visible";return}f.value="tracing",_.animate([{strokeDashoffset:c.value},{strokeDashoffset:0}],{duration:Yo,easing:"cubic-bezier(0.25, 0.1, 0.25, 1)",fill:"forwards"}).finished.then(()=>{f.value="filling",setTimeout(()=>{f.value="visible"},Xo)})}function A(_){if(o.value==="reduced")return;_.preventDefault();const L=w();if(!L)return;const G=L.getBoundingClientRect();i({slug:t.shader.slug,rect:{top:G.top,left:G.left,width:G.width,height:G.height},screenshotUrl:t.shader.screenshotUrl});const V=L.parentElement;V&&Array.from(V.children).filter(H=>H!==L).forEach(H=>{H.animate([{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.95)"}],{duration:Dc,easing:"ease-out",fill:"forwards"})}),setTimeout(()=>{r.push("/shader/"+t.shader.slug)},100)}return n({triggerEntrance:S,getCardEl:w}),(_,L)=>{const G=ii("router-link");return Ae(),no(G,{ref_key:"cardRef",ref:s,to:"/shader/"+e.shader.slug,class:Wn(["shader-card n-panel n-corner-frame",{"card--hidden":f.value==="hidden","card--tracing":f.value==="tracing","card--filling":f.value==="filling","card--visible":f.value==="visible"}]),onClick:A},{default:Zr(()=>[(Ae(),Fe("svg",qf,[Pe("rect",{ref_key:"svgRef",ref:l,class:"entrance-trace",x:"0.5",y:"0.5",rx:"8",ry:"8",width:"calc(100% - 1px)",height:"calc(100% - 1px)",fill:"none","stroke-dasharray":c.value,"stroke-dashoffset":c.value,"stroke-width":"2"},null,8,Wf)])),Pe("div",Kf,[Pe("img",{src:e.shader.screenshotUrl,alt:e.shader.title,loading:"lazy",class:"card-image"},null,8,Yf),L[0]||(L[0]=Pe("div",{class:"card-scanline","aria-hidden":"true"},null,-1)),Pe("div",Xf,[Pe("span",jf,ot(e.shader.date),1),Pe("span",Qf,ot(e.shader.title),1)]),Pe("div",Zf,[(Ae(!0),Fe(Te,null,$r(e.shader.tags,V=>(Ae(),Fe("span",{key:V,class:"card-tag"},ot(V),1))),128))])])]),_:1},8,["to","class"])}}}),Jf=wt($f,[["__scopeId","data-v-7a7f8a11"]]),Rt=200,ga=40,ed=280,nd=12,ya=85,td=55,ba=.45,rd=.12,od=.25,ad=15;function id(e){let n=0,t=-1,r=-1,o=!0;function a(f){const c=e.value;if(!c)return;const d=c.getBoundingClientRect();t=f.clientX-d.left,r=f.clientY-d.top}function i(){t=-1,r=-1}function s(){o=!document.hidden,o&&e.value&&(n=requestAnimationFrame(l))}function l(f){if(!o)return;const c=e.value;if(!c)return;const d=c.getContext("2d");if(!d)return;const m=window.devicePixelRatio||1,v=c.clientWidth,T=c.clientHeight;if(v===0||T===0){n=requestAnimationFrame(l);return}const w=Math.round(v*m),k=Math.round(T*m);(c.width!==w||c.height!==k)&&(c.width=w,c.height=k),d.setTransform(m,0,0,m,0,0),d.clearRect(0,0,v,T);const M=f*.001,S=M*Hc,A=M*nd,_=2;for(let L=0;L<pr;L++){const G=L/(pr-1),V=T*(.08+G*.84),oe=L*Math.PI*.6,H=Mc+L%3*.3,Y=1+(L%2===0?.15:-.1)*(L/pr),I=(ga+G*(ed-ga)+A)%360,X=Math.abs(G-.5)*2;let le=ba-(ba-rd)*X,ve=td;const ce=.4+L%4*.15,J=Math.sin(M*ce+L*1.7)*.5+.5;le*=.7+J*.3;let K=0;if(t>=0&&r>=0){const de=Math.abs(V-r);de<Rt&&(K=1-de/Rt,K*=K,le=Math.min(1,le+od*K),ve=ve+ad*K)}const ze=`hsla(${I}, ${ya}%, ${ve}%, ${le})`,Xe=`hsla(${I}, ${ya}%, ${ve}%, ${le*.5})`;d.beginPath(),d.strokeStyle=ze,d.lineWidth=kc+K*.5,d.shadowColor=Xe,d.shadowBlur=Bc+K*6;for(let de=0;de<=v;de+=_){let ge=Lc;if(t>=0&&r>=0){const sn=de-t,je=V-r,Ee=Math.sqrt(sn*sn+je*je);if(Ee<Rt){const y=1-Ee/Rt;ge+=Oc*y*y}}const an=V+Math.sin(de/v*Math.PI*2*H+S*Y+oe)*ge;de===0?d.moveTo(de,an):d.lineTo(de,an)}d.stroke(),d.shadowBlur=0}n=requestAnimationFrame(l)}Qn(()=>{const f=e.value;f&&(f.addEventListener("mousemove",a),f.addEventListener("mouseleave",i),document.addEventListener("visibilitychange",s),n=requestAnimationFrame(l))}),St(()=>{cancelAnimationFrame(n);const f=e.value;f&&(f.removeEventListener("mousemove",a),f.removeEventListener("mouseleave",i)),document.removeEventListener("visibilitychange",s)})}const sd=An({__name:"SineWaveDivider",setup(e){const n=Ce(null);return id(n),(t,r)=>(Ae(),Fe("canvas",{ref_key:"canvasRef",ref:n,class:"sine-wave-bg","aria-hidden":"true"},null,512))}}),ld=wt(sd,[["__scopeId","data-v-05c59859"]]),cd={class:"gallery-view n-layout-shell"},fd={key:0,class:"gallery-empty"},dd=An({__name:"GalleryView",setup(e){const{activeTag:n,allTags:t,filteredShaders:r,setTag:o}=Ff(),{triggerCardExit:a,prefersReducedMotion:i}=oo(),s=Ce(null),l=Ce(null);Hr(s,".profile-link, .github-link"),Hr(l,".shader-card",".card-overlay",8);function f(d,m){if(i.value==="reduced"){m();return}setTimeout(m,800)}function c(d,m){if(i.value==="reduced"){m();return}a(d).then(m)}return(d,m)=>(Ae(),Fe("div",cd,[Pe("header",{ref_key:"headerRef",ref:s,class:"gallery-header n-panel"},[ue(ld),m[0]||(m[0]=kl('<div class="gallery-brand" data-v-80cb8cf0><a href="https://guinetik.com" target="_blank" rel="noopener" class="brand-logo-link" aria-label="Visit Guinetik website" data-v-80cb8cf0><svg class="brand-logo" xmlns="http://www.w3.org/2000/svg" viewBox="32.9 174.743 71.888 63.576" aria-hidden="true" data-v-80cb8cf0><path d="M 57.971 224.292 L 57.971 203.374 L 57.971 194.861 L 75.109 194.861 L 75.109 188.769 L 63.16 188.769 L 63.16 174.743 L 57.971 174.743 L 57.971 189.041 L 57.971 194.861 L 32.9 194.861 L 32.9 203.773 L 50.377 203.773 L 50.377 224.292 L 57.971 224.292 Z M 79.717 238.319 L 79.717 224.02 L 79.717 218.2 L 104.788 218.2 L 104.788 209.287 L 87.31 209.287 L 87.31 188.769 L 79.717 188.769 L 79.717 209.686 L 79.717 218.2 L 62.579 218.2 L 62.579 224.293 L 74.526 224.293 L 74.526 238.319 L 79.717 238.319 Z" data-v-80cb8cf0></path></svg></a><h1 class="gallery-title" data-v-80cb8cf0>Guinetik&#39;s Shaders Collection</h1></div><nav class="gallery-links" aria-label="Profile links" data-v-80cb8cf0><a href="https://guinetik.com" target="_blank" rel="noopener" class="profile-link" data-v-80cb8cf0>Website</a><a href="https://www.shadertoy.com/user/guinetik" target="_blank" rel="noopener" class="profile-link" data-v-80cb8cf0>Shadertoy</a><a href="https://x.com/guinetik" target="_blank" rel="noopener" class="github-link" aria-label="Visit Guinetik on X" title="X (Twitter)" data-v-80cb8cf0><svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true" data-v-80cb8cf0><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" data-v-80cb8cf0></path></svg></a><a href="https://github.com/guinetik" target="_blank" rel="noopener" class="github-link" aria-label="Visit Guinetik on GitHub" title="GitHub" data-v-80cb8cf0><svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor" aria-hidden="true" data-v-80cb8cf0><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.5-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z" data-v-80cb8cf0></path></svg></a></nav><p class="gallery-subtitle" data-v-80cb8cf0> Interactive GPU programming experiments using WebGL. </p>',3))],512),ue(Vf,{tags:Le(t),activeTag:Le(n),onSelect:Le(o)},null,8,["tags","activeTag","onSelect"]),Pe("div",{ref_key:"gridRef",ref:l},[ue(xc,{name:"shader-card",tag:"div",class:"gallery-grid",onEnter:f,onLeave:c,css:!1},{default:Zr(()=>[(Ae(!0),Fe(Te,null,$r(Le(r),(v,T)=>(Ae(),no(Jf,{key:v.slug,shader:v,index:T,total:Le(r).length},null,8,["shader","index","total"]))),128))]),_:1})],512),Le(r).length===0?(Ae(),Fe("p",fd," No shaders found. ")):Ci("",!0)]))}}),pd=wt(dd,[["__scopeId","data-v-80cb8cf0"]]),ud=[{path:"/",name:"gallery",component:pd},{path:"/shader/:slug",name:"shader-detail",component:()=>Zc(()=>import("./ShaderDetailView-BOrsCD87.js"),__vite__mapDeps([0,1]))}],Qi=of({history:H0(),routes:ud});Qi.afterEach(e=>{typeof window.gtag=="function"&&window.gtag("event","page_view",{page_path:e.fullPath})});Ac(Xc).use(Qi).mount("#app");export{Ya as A,Qo as C,hd as F,md as M,vd as S,wt as _,Fe as a,Ci as b,ke as c,An as d,Pe as e,yd as f,Ae as g,Zc as h,Te as i,$r as j,oo as k,Hr as l,Qn as m,Wn as n,St as o,ue as p,Zr as q,Ce as r,no as s,ot as t,Le as u,Hl as v,st as w,gd as x,ii as y,af as z};
